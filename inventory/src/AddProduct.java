...
public class AddProduct extends Modules { // System function, adds product to inventory
    ...
    public void userOptions() throws IOException { // displays menu for user
    ...
    public void userInput() throws IOException { // handles module's input
